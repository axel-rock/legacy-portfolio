...
Helper.createElement = function(options) {
	options = Object.assign({
		...
		alignItems: 'center',
		position: 'absolute',
		parent: document.getElementById('EUROSPORT_ADTECH_clicktag') || document.body,
		retina: true,
...
function init() {
  ...
  Helper.preloadImages(images, function() {
    ...
    var product_end = Helper.createElement({image: 'images/product.png', parent: banner})
    ...
    var scene = Helper.createElement({width: width, height: height, parent: banner})
      var city = Helper.createElement({image: 'images/city.jpg', parent: scene})
      var character_girl = Helper.createElement({image: 'images/character_girl.png', transformOrigin: '50% 100%', parent: scene})
      var character_boy = Helper.createElement({image: 'images/character_boy.png', transformOrigin: '50% 100%', parent: scene})
      var bridge_front = Helper.createElement({image: 'images/bridge_front.png', parent: scene})

    var clouds = Helper.createElement({width: width, height: height, parent: banner})
      var background_start = Helper.createElement({image: 'images/background_start.jpg', retina: false, parent: clouds})
      var product = Helper.createElement({image: 'images/product.png', top: 30, parent: clouds})
      var logo = Helper.createElement({image: 'images/logo.png', parent: clouds})
      var cloud_2 = Helper.createElement({image: 'images/cloud_2.png', bottom: 0, left: width, retina: false, parent: clouds})
      var bird = Helper.createElement({image: 'images/bird.png', transformOrigin: '50% 100%', parent: clouds})
      var cloud_1 = Helper.createElement({image: 'images/cloud_1.png', bottom: 0, right: width, retina: false, parent: clouds})
