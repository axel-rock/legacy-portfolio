...
function init() {
	...
	Helper.preloadImages(images, function() {
		var background_end = Helper.createElement({image: 'images/nuit_background_start.jpg', retina: false, scaleX: -1, parent: banner})
		...
		var background_start = Helper.createElement({image: 'images/nuit_background_start.jpg', retina: false, scale: 1.1, y: 35, parent: frame_1})

		var frame_1_scale = Helper.createElement({width: width, height: height, parent: frame_1})
		var product = Helper.createElement({image: 'images/nuit_product.jpg', y: 40, parent: frame_1_scale})
		var product_mask = Helper.createElement({image: 'images/nuit_product_mask.png', parent: frame_1_scale})
		var logo = Helper.createElement({image: 'images/nuit_logo.png', parent: frame_1_scale})
		...
		tl
		.to(product, 3.5, {scale: 1.4, ease: Power0.easeNone})
