...
function init() {
	...
	images = [
		'images/nuit_bridge_front.png',
		'images/nuit_character_boy.png',
		'images/nuit_character_girl.png',
		'images/nuit_city.jpg',
		'images/nuit_logo.png',
		'images/nuit_background_start.jpg',
		'images/nuit_city_overlay.jpg',
		'images/nuit_product.jpg',
		'images/nuit_product_mask.png',
		'images/nuit_txt_1.png',
	]

	// TweenMax.ticker.fps(24)

	Helper.preloadImages(images, function() {
		var background_end = Helper.createElement({image: 'images/nuit_background_start.jpg', right: 0, retina: false, parent: banner})
		var product_end = Helper.createElement({image: 'images/nuit_product.jpg', parent: banner})
		var product_end_mask = Helper.createElement({image: 'images/nuit_product_mask.png', parent: banner})
		var logo_end = Helper.createElement({image: 'images/nuit_logo.png', parent: banner})
		var txt_1 = Helper.createElement({image: 'images/nuit_txt_1.png', parent: banner})

		var scene = Helper.createElement({width: width, height: height, parent: banner})
		var city = Helper.createElement({image: 'images/nuit_city.jpg', retina: false, parent: scene})
		var character_girl = Helper.createElement({image: 'images/nuit_character_girl.png', transformOrigin: '50% 100%', retina: false, parent: scene})
		var character_boy = Helper.createElement({image: 'images/nuit_character_boy.png', transformOrigin: '50% 100%', retina: false, parent: scene})
		var bridge_front = Helper.createElement({image: 'images/nuit_bridge_front.png', retina: false, parent: scene})

		var frame_1 = Helper.createElement({width: width, height: height, parent: banner})
		var background_start = Helper.createElement({image: 'images/nuit_background_start.jpg', left: -150, retina: false, scale: 1.1, y: 35, parent: frame_1})

		var frame_1_scale = Helper.createElement({width: width, height: height, parent: frame_1})
		var product = Helper.createElement({image: 'images/nuit_product.jpg', x: 250, parent: frame_1_scale})
		var product_mask = Helper.createElement({image: 'images/nuit_product_mask.png', parent: frame_1_scale})
		var logo = Helper.createElement({image: 'images/nuit_logo.png', x: 200, parent: frame_1_scale})

		var city_overlay = Helper.createElement({image: 'images/nuit_city_overlay.jpg', bottom: 0, retina: false, parent: banner})
		...
		tl
		.to(frame_1_scale, 3.5, {scale: 1.4, ease: Power0.easeNone})

		.from(city_overlay, 0.8, {opacity: 0, ease: Power0.easeNone}, 1.2)
		.fromTo(city_overlay, 3.8, {y: city_overlay.height - height, scale: 1}, {y: -city_overlay.height * 0.1, scale: 1.2, ease: Power1.easeIn}, 0.7)
