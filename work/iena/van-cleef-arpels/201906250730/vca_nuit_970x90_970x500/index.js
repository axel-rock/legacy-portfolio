...
function init() {
	...
	wrapper = Helper.createElement({id: 'border', width: width, height: 90, right: 0, overflow: 'hidden', border: 'solid 1px #ccc', parent: container}),
	border = Helper.createElement({id: 'border', width: width, height: height, backgroundColor: '#10101c', overflow: 'hidden', parent: wrapper}),
	...
	TweenMax.set(closeButton, {display: 'none'});
	...
	Helper.preloadImages(images, function() {
		...
		var product_end = Helper.createElement({image: 'images/product.jpg', x: -200, parent: banner})
		...
		var product = Helper.createElement({image: 'images/product.jpg', x: 200, parent: frame_1_scale})
		var product_mask = Helper.createElement({image: 'images/product_mask.png', parent: frame_1_scale})
		var logo = Helper.createElement({image: 'images/logo.png', x: -400, y: 75, parent: frame_1_scale})

		var city_overlay = Helper.createElement({image: 'images/city_overlay.jpg', bottom: 0, retina: false, parent: banner})

		var collapsed = Helper.createElement({width: width, height: 90, parent: banner})
		var background_collapsed = Helper.createElement({image: 'images/background_collapsed.jpg', retina: false, parent: collapsed})
		var logo_collapsed = Helper.createElement({image: 'images/logo_collapsed.png?v=2', parent: collapsed})
		var txt_1_collapsed = Helper.createElement({image: 'images/txt_1_collapsed.png', parent: collapsed})
		...
		.fromTo(city_overlay, 3.8, {y: city_overlay.offsetHeight - height - 50, scale: 1}, {y: -city_overlay.offsetHeight * 0.1, scale: 1.2, ease: Power1.easeIn}, 0.7)
		...
		function onMouseEnter() {
			EB.expand();
			TweenMax.set(wrapper, {height: 500});
			TweenMax.set(collapsed, {opacity: 0});
			TweenMax.set(closeButton, {display: 'inline-block'});
			tl.play(0);
		...
		closeButton.addEventListener('click', function() {
			EB.collapse();
			TweenMax.set(wrapper, {height: 90});
			TweenMax.set(collapsed, {opacity: 1});
			TweenMax.set(closeButton, {display: 'none'});
			tl.play(5.1);
