...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product = Helper.createElement({image: 'images/product.jpg', top: 10, parent: clouds})
		...
		var cloud_2 = Helper.createElement({image: 'images/cloud_1.jpg', bottom: 100, left: width * 2, scaleX: -1.5, scaleY: 1.5, retina: false, parent: clouds})
		...
		tl
		.fromTo(product, 2.7, {scale: 1}, {scale: 1.2, ease: Power0.easeNone})

		.to(cloud_1, 1.7, {x: 310, ease: Power0.easeNone}, 1.5)
		.to(cloud_2, 1.7, {x: -800, ease: Power0.easeNone}, 1.3)
