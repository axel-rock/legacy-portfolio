...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product_end = Helper.createElement({image: 'images/product.jpg', scale: 0.8, y: -10, parent: banner})
		...
		var background_start = Helper.createElement({image: 'images/background_start.jpg', retina: false, scale: 1.1, y: 35, parent: frame_1})

		var frame_1_scale = Helper.createElement({width: width, height: height, parent: frame_1})
		var product = Helper.createElement({image: 'images/product.jpg', y: 40, parent: frame_1_scale})
		...
		tl
		.to([background_start, product], 3.5, {scale: 1.2, ease: Power0.easeNone})
