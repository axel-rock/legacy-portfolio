...
function init() {
	...
	wrapper = Helper.createElement({id: 'border', width: 300, height: height, right: 0, overflow: 'hidden', parent: container}),
	border = Helper.createElement({id: 'border', width: width, height: height, backgroundColor: '#e1daf9', border: 'solid 1px #ccc', overflow: 'hidden', parent: wrapper}),
	...
	Helper.preloadImages(images, function() {
		...
		var bird = Helper.createElement({image: 'images/bird.png', transformOrigin: '50% 100%', x: 200, parent: clouds})
		...
		function onMouseEnter() {
			EB.expand();
			TweenMax.set(wrapper, {width: 550});
		...
		closeButton.addEventListener('click', function() {
			EB.collapse();
			TweenMax.set(wrapper, {width: 300});
			TweenMax.set(closeButton, {display: 'none'});
			tl.play(5.1);
