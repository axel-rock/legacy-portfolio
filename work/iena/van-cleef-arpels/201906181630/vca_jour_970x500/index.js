...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product = Helper.createElement({image: 'images/product.jpg', x: 300, parent: scalable})
		var product_mask = Helper.createElement({image: 'images/product_mask.png', parent: scalable})
		var logo = Helper.createElement({image: 'images/logo.png', y: 40, x: -300, parent: scalable})
