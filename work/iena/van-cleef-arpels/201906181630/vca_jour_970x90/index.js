...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product = Helper.createElement({image: 'images/product.jpg', x: 125, parent: scalable})
		var product_mask = Helper.createElement({image: 'images/product_mask.png', parent: scalable})
		var logo = Helper.createElement({image: 'images/logo.png', x: 125, parent: scalable})
		...
		.fromTo(bird, 2, {rotation: 45, x: 500, }, {rotation: -45, x: 300, ease: Power0.easeNone}, 1.8)
		...
		.fromTo(character_girl, 2.4, {rotation: -15}, {rotation: -3, ease: Power0.easeNone}, 2.8)
		.fromTo(character_boy, 2.4, {rotation: 15}, {rotation: 3, ease: Power0.easeNone}, 2.8)
