...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product_end = Helper.createElement({image: 'images/product.png', scale: 0.8, y: -25, parent: banner})
		...
		var product = Helper.createElement({image: 'images/product.png', y: -5, parent: frame_1_scale})
