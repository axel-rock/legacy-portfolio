...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product_end = Helper.createElement({image: 'images/jour_product.jpg', parent: banner})
		...
		var product = Helper.createElement({image: 'images/jour_product.jpg', top: 50, parent: clouds})
