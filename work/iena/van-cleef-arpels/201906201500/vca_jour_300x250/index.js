...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product_end = Helper.createElement({image: 'images/product.jpg', scale: 0.8, y: -22, parent: banner})
		...
		var product = Helper.createElement({image: 'images/product.jpg', parent: clouds})
		...
		var bird = Helper.createElement({image: 'images/bird.png', transformOrigin: '50% 100%', x: 100, parent: clouds})
		...
		tl
		.fromTo(product, 3.5, {scale: 0.9}, {scale: 1.2, ease: Power0.easeNone})

		.to(cloud_1, 2.8, {x: 374, ease: Power0.easeNone}, 0.7)
		.to(cloud_2, 2.8, {x: -374 * 1.6, ease: Power0.easeNone}, 0.5)
