...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product_end = Helper.createElement({image: 'images/product.jpg', x: -280, parent: banner})
		...
		var product = Helper.createElement({image: 'images/product.jpg', parent: frame_1_scale})
		var product_mask = Helper.createElement({image: 'images/product_mask.png', parent: frame_1_scale})
		var logo = Helper.createElement({image: 'images/logo.png', x: -330, y: 50, parent: frame_1_scale})
		...
		function onMouseEnter() {
			EB.expand();
			TweenMax.set(wrapper, {height: 300});
