...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product = Helper.createElement({image: 'images/product.jpg', parent: frame_1})
		var product_mask = Helper.createElement({image: 'images/product_mask.png', parent: frame_1})
		var logo = Helper.createElement({image: 'images/logo.png', x: -330, y: 50, parent: frame_1})
		...
		.from(city_overlay, 2.8, {y: 200, ease: Power0.easeNone}, 0.7)
		.to(city_overlay, 0.3, {opacity: 0, ease: Power0.easeNone}, 3.2)

		.from(scene, 0.2, {opacity: 0, ease: Power0.easeNone}, 3)
		.to(product, 0.3, {opacity: 0, ease: Power0.easeNone}, 3)
		.to(frame_1, 0.3, {opacity: 0, ease: Power0.easeNone}, 3)
