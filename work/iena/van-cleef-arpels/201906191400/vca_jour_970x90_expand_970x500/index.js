...
function init() {
	...
	border = Helper.createElement({id: 'border', width: width, height: height, backgroundColor: '#e1daf9', overflow: 'hidden', parent: wrapper}),
	...
	Helper.preloadImages(images, function() {
		...
		var product = Helper.createElement({image: 'images/product.jpg', x: 400, parent: scalable})
		var product_mask = Helper.createElement({image: 'images/product_mask.png', parent: scalable})
		var logo = Helper.createElement({image: 'images/logo.png', y: 60, x: -400, parent: scalable})
		var cloud_2 = Helper.createElement({image: 'images/cloud_1.jpg', left: width * 1.6, scaleX: -1.5, scaleY: 1.5, retina: false, parent: clouds})
