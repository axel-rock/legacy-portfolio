...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var product_end = Helper.createElement({image: 'images/product.png', scale: 0.8, y: -22, parent: banner})
		...
		var product = Helper.createElement({image: 'images/product.png', parent: clouds})
