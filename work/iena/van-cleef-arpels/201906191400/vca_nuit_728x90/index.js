...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var frame_1 = Helper.createElement({width: width, height: height, left: 120, transformOrigin: (width / 2 - 100) + 'px center', parent: banner})
		...
		var product = Helper.createElement({image: 'images/product.png', parent: frame_1_scale})
		// var product_mask = Helper.createElement({image: 'images/product_mask.png', parent: frame_1_scale})
		var logo = Helper.createElement({image: 'images/logo.png', parent: frame_1_scale})
		...
		TweenMax.set([character_girl, character_boy], {clip: 'rect(' + (height * 0.1) + 'px,' + (width * 0.9) + 'px,' + (300 * 0.9) + 'px,' + (width * 0.1) + 'px)'}) // Firefox overflow fix

		tl
		.to(frame_1, 3.5, {scale: 1.4, ease: Power0.easeNone})
