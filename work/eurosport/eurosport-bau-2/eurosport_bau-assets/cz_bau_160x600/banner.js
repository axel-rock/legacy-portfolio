...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var frame_3 = Helper.createElement({id: 'frame_3', width: width, height: height - 40, position: 'absolute', top: 0, parent: banner})
			var txt_5 = Helper.createTextElement('TXT_5', frame_3, {fontStyle: 'italic', width: 160, padding: 15, x: -3})
			var devices = Helper.createElement({image: 'devices.png', marginTop: 10, parent: frame_3})
			var txt_6 = Helper.createTextElement('TXT_6', frame_3, {fontStyle: 'italic', width: 160, padding: 15, x: -3, position: 'absolute'})
			var logos = Helper.createElement({image: 'logos.png', position: 'absolute', parent: frame_3})

		var image_container = Helper.createElement({id: 'image_container', width: width, height: height, position: 'absolute', bottom: 0, clip: clip(5), overflow: 'hidden', parent: banner})
		...
		var frame_2 = Helper.createElement({id: 'frame_2', width: width, height: height, clip: clip(5), position: 'absolute', top: 0, parent: banner})
			var txt_1 = Helper.createTextElement('TXT_1', frame_2, {fontStyle: 'italic', position: 'absolute', width: 160, padding: 15, x: -3})
			var txt_2 = Helper.createTextElement('TXT_2', frame_2, {fontStyle: 'italic', position: 'absolute', width: 160, padding: 15, x: -3, textShadow: '0px 0px 10px rgba(0, 0, 0, 0.3)'})
			var txt_3 = Helper.createTextElement('TXT_3', frame_2, {fontStyle: 'italic', position: 'absolute', width: 160, padding: 15, x: -3, textShadow: '0px 0px 10px rgba(0, 0, 0, 0.3)'})
			var txt_4 = Helper.createTextElement('TXT_4', frame_2, {fontStyle: 'italic', position: 'absolute', width: 160, padding: 15, x: -3, textShadow: '0px 0px 10px rgba(0, 0, 0, 0.3)'})
		...
		var frame_1 = Helper.createElement({id: 'frame_1', width: width, height: height, position: 'absolute', parent: banner})
			...
			var txt_0_wrapper = Helper.createElement({overflow: 'hidden', parent: frame_1})
				var txt_0 = Helper.createTextElement('TXT_0', txt_0_wrapper, {width: 150, height: 64, fontSize: 44})
			var cta_wrapper = Helper.createElement({overflow: 'hidden', marginTop: 80, parent: frame_1})
				var cta = Helper.createTextElement('TXT_CTA', cta_wrapper, {padding: '5px 5px', width: 150})
		...
		tl
			...
			// Reset
			.to(txt_0_wrapper, 0.01, {y: height, width: 150, height: 64}, 'frame_2-=0.01')
			...
			.to(txt_0_wrapper, 0.5, {y: height - txt_0.getBoundingClientRect().top - txt_0.getBoundingClientRect().height + cta.getBoundingClientRect().height / 2, opacity: 1}, 'frame_2')
			...
			.addLabel('frame_8')
			.to(txt_0_wrapper, 0.5, {y: - txt_0.getBoundingClientRect().top + cta.getBoundingClientRect().height / 2}, 'frame_8')
