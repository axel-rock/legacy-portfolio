...
function init() {
	...
	Helper.preloadImages(images, function() {
		...
		var frame_3 = Helper.createElement({id: 'frame_3', width: width, height: height - 40, position: 'absolute', top: 0, parent: banner})
			var txt_5 = Helper.createTextElement('TXT_5', frame_3, {fontStyle: 'italic', padding: 15, x: -3})
			var devices = Helper.createElement({image: 'devices.png', marginTop: 10, parent: frame_3})
			var txt_6 = Helper.createTextElement('TXT_6', frame_3, {fontStyle: 'italic', padding: 15, x: -3, position: 'absolute'})
		...
		var frame_2 = Helper.createElement({id: 'frame_2', width: width, height: height, clip: clip(15), position: 'absolute', top: 0, parent: banner})
			var txt_1 = Helper.createTextElement('TXT_1', frame_2, {fontStyle: 'italic', position: 'absolute', padding: 15, x: -3})
			var txt_2 = Helper.createTextElement('TXT_2', frame_2, {fontStyle: 'italic', position: 'absolute', padding: 15, x: -3, textShadow: '0px 0px 10px rgba(0, 0, 0, 0.3)'})
			var txt_3 = Helper.createTextElement('TXT_3', frame_2, {fontStyle: 'italic', position: 'absolute', padding: 15, x: -3, textShadow: '0px 0px 10px rgba(0, 0, 0, 0.3)'})
			var txt_4 = Helper.createTextElement('TXT_4', frame_2, {fontStyle: 'italic', position: 'absolute', padding: 15, x: -3, textShadow: '0px 0px 10px rgba(0, 0, 0, 0.3)'})
		...
		var frame_1 = Helper.createElement({id: 'frame_1', width: width, height: height, position: 'absolute', parent: banner})
			...
			var txt_0_wrapper = Helper.createElement({overflow: 'hidden', parent: frame_1})
				var txt_0 = Helper.createTextElement('TXT_0', txt_0_wrapper, {width: 200, height: 80, fontSize: 60})
			...
			var badges = Helper.createElement({image: 'badges.png', marginTop: 40, parent: frame_1})
		...
		tl
			...
			// Reset
			.to(txt_0, 0.01, {fontSize: 44}, 'frame_2-=0.01')
			...
			.to(txt_0_wrapper, 0.5, {y: height - txt_0.getBoundingClientRect().top - txt_0.getBoundingClientRect().height * 0.9 + cta.getBoundingClientRect().height / 2, opacity: 1}, 'frame_2')
			...
			.addLabel('frame_8')
			.to(txt_0_wrapper, 0.5, {y: - txt_0.getBoundingClientRect().top + 7}, 'frame_8')
