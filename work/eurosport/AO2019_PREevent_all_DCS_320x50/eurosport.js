...
Helper.createTextElement = function(args) {
	...
	var container = Helper.createElement({display: 'flex', flexDirection: 'column', alignItems: args[0].alignItems || 'center', justifyContent: args[0].justifyContent || 'center', width: '100%', height: '100%', textAlign: args[0].textAlign || 'center', parent: args[0].parent})
